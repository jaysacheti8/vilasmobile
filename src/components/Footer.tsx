    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container-wide section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center md:text-left">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif text-lg mb-4 md:mb-6">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="font-serif text-lg mb-4 md:mb-6">Services</h4>
            <ul className="space-y-2 md:space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-serif text-lg mb-4 md:mb-6">Contact</h4>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-primary-foreground/10 mt-12 md:mt-16 pt-6 md:pt-8 text-center">
